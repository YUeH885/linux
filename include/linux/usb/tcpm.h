 ...
 * @avoid_snk_hard_reset:
 *		Optional; return true when a sink hard reset could interrupt a
 *		non-PD supply or an attachment inherited across boot.
 */
struct tcpc_dev {
	...
	bool (*avoid_snk_hard_reset)(struct tcpc_dev *dev);
};
